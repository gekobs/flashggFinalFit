...
python /home/users/azecchin/Analysis/FinalFit/CMSSW_10_2_13/src/flashggFinalFit/Datacard/makeYields.py --cat SR1 --procs auto --ext modLoose --mass 125 --inputWSDirMap 2018=/home/users/azecchin/Analysis/FinalFit/CMSSW_10_2_13/src/flashggFinalFit/files_systs/modLoose/ws_signal_2018 --sigModelWSDir ./Models/signal --sigModelExt packaged --bkgModelWSDir ./Models/background --bkgModelExt multipdf  --mergeYears --skipZeroes
